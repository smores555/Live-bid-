...
- 1. Strict cap — rank must be <= targetMap capacity.
- 1. Vacancy gate — moving INTO a foreign position requires vacancy > 0.
- EXCEPTION: bidding back to p.orig is always vacancy-free (home base).
- 1. BPL skip tracking — explains why higher prefs were bypassed.
- 1. Live ledger strings — vacancy numbers snapshotted at move-moment.
   */
